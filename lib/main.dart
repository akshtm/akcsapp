...
import 'package:akcsapp/Controllers_Getx/userdetailsController.dart';
import 'package:akcsapp/Models/Adress/AdressModel.dart';
import 'package:akcsapp/sPlash_sCreen.dart';
...
Future<void> main() async {
  ...
  if (!Hive.isAdapterRegistered(AdressModelAdapter().typeId)) {
